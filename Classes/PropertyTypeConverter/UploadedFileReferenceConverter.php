<?php
namespace CDpackage\Cmcd\PropertyTypeConverter;
...
class UploadedFileReferenceConverter extends AbstractTypeConverter
{
    ...
    protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration)
    {
        ...
        $allowedFileExtensions = $configuration->getConfigurationValue('CDpackage\\Cmcd\\PropertyTypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
        ...
        $uploadFolderId = $configuration->getConfigurationValue('CDpackage\\Cmcd\\PropertyTypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
        ...
        $conflictMode = $configuration->getConfigurationValue('CDpackage\\Cmcd\\PropertyTypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $defaultConflictMode;
     ...
     * @return \CDpackage\Cmcd\Domain\Model\FileReference
     */
